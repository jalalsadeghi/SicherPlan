...
ROLES: tuple[RoleSeed, ...] = (
    ...
    RoleSeed(
        ...
        False,
        ("platform.info.read", "platform.integration.read", "customers.customer.read", "employees.employee.read"),
    ),
    RoleSeed(
        "accounting",
        "Accounting",
        ...
        False,
        ("platform.info.read", "platform.integration.read", "customers.customer.read", "customers.billing.read"),
    ),
    RoleSeed(
        "controller_qm",
        "Controlling / QA",
        ...
        False,
        ("platform.info.read", "platform.info.write", "platform.integration.read", "customers.customer.read", "employees.employee.read"),
    ),
    RoleSeed(
        "customer_user",
