...
PERMISSIONS: tuple[PermissionSeed, ...] = (
    ...
    PermissionSeed("customers.portal_access.read", "customers", "portal_access_read", "Read customer portal access credentials for tenant-managed customers."),
    PermissionSeed("customers.portal_access.write", "customers", "portal_access_write", "Create and manage customer portal access credentials."),
    ...
    PermissionSeed("assistant.chat.access", "assistant", "chat_access", "Access the read-only AI assistant chat surfaces."),
    PermissionSeed(
        "assistant.diagnostics.read",
        "assistant",
        "diagnostics_read",
        "Run read-only assistant diagnostics alongside required domain permissions.",
    ),
    PermissionSeed(
        "assistant.feedback.write",
        "assistant",
        "feedback_write",
        "Submit end-user feedback for assistant responses.",
    ),
    PermissionSeed(
        "assistant.knowledge.read",
        "assistant",
        "knowledge_read",
        "Use indexed platform knowledge for assistant how-to answers.",
    ),
    PermissionSeed(
        "assistant.knowledge.reindex",
        "assistant",
        "knowledge_reindex",
        "Trigger assistant knowledge reindex operations.",
    ),
    PermissionSeed(
        "assistant.admin",
        "assistant",
        "admin",
        "Manage administrative assistant capabilities and support operations.",
    ),
