...
describe('preferences', () => {
  ...
  it('normalizes unsupported cached locales back to german', async () => {
    await preferenceManager.initPreferences({
      namespace: 'testNamespaceUnsupportedLocale',
      overrides: {
        app: {
          locale: 'fr-FR',
        },
    ...
    expect(preferenceManager.getPreferences().app.locale).toBe('de-DE');
  });
