...
- New order [verified]: Starts the customer-scoped order workspace from the selected customer's Orders tab.
...
- Neuer Auftrag [verified]: Startet den kundenbezogenen Order-Workspace aus dem Orders-Tab des ausgewählten Kunden.
...
- Previous [verified]: Moves back to the previous saved order-workspace step.
- Next [verified]: Validates and saves the current step before the wizard advances.
- Generate Series & Continue [verified]: Generates concrete shifts from the shift series and redirects into Staffing Coverage.

### Sections

- Order details: Order no, Title, Requirement type, Service category, Service from, Service to
- Order scope & documents: Equipment lines, Requirement lines, Order documents
- Planning record overview: Planning mode, Planning from, Planning to
- Planning record documents: Planning documents
- Shift plan: Shift plan name, Workforce scope
- Series & exceptions: Shift template, Recurrence, Date from, Date to

### Follow-up

- Generate Series & Continue into Staffing Coverage
...
- Zurück [verified]: Wechselt zum vorherigen gespeicherten Schritt des Order-Workspaces.
- Weiter [verified]: Validiert und speichert den aktuellen Schritt, bevor der Wizard weitergeht.
- Serie erzeugen und weiter [verified]: Erzeugt konkrete Schichten aus der Schichtserie und leitet nach Staffing Coverage weiter.

### Sections

- Auftragsdetails: Auftragsnummer, Titel, Bedarfsart, Leistungskategorie, Leistung von, Leistung bis
- Auftragsumfang und Dokumente: Equipment-Zeilen, Anforderungszeilen, Auftragsdokumente
- Planungsdatensatz Übersicht: Planungsmodus, Planung von, Planung bis
- Planungsdokumente: Planungsdokumente
- Schichtplan: Name Schichtplan, Workforce Scope
- Serien und Ausnahmen: Schichtvorlage, Wiederholung, Datum von, Datum bis

### Follow-up

- Serie erzeugen und nach Staffing Coverage wechseln
