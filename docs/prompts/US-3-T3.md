...
Use this after the implementation for **US-3-T3 — Implement theme tokens using light rgb(40,170,170) and dark rgb(35,200,205) across web/mobile** is finished.

```text
/review Please review the implementation for task US-3-T3 (Implement theme tokens using light rgb(40,170,170) and dark rgb(35,200,205) across web/mobile) against this prompt file and the current repository state.

Review goals:
- Confirm the implementation matches the objective, dependencies, hard constraints, expected outputs, non-goals, and verification checklist in `docs/prompts/US-3-T3.md`.
